  ...
  return (
    <AuthLayout>
      ...
      <CBoxContainer>
        <CBox>
          <SHeader>한식</SHeader>
          <Img src="http://localhost:3100/bibimbap.jpg" alt="img" />
          <Info>
            <h1>비빔밥</h1>
            <span>
        ...
        <CBox>
          <SHeader>일식</SHeader>
          <Img src="http://localhost:3100/ramen.jpg" alt="img" />
          <Info>
            <h1>라맨</h1>
        ...
        <CBox>
          <SHeader>중식</SHeader>
          <Img src="http://localhost:3100/jajangmyeon.jpg" alt="img" />
          <Info>
            <h1>짜장면</h1>
            <span>
        ...
        <CBox>
          <SHeader>양식</SHeader>
          <Img src="http://localhost:3100/pasta.jpg" alt="img" />
          <Info>
            <h1>파스타</h1>
            <span>
